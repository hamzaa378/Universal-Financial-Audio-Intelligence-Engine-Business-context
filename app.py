...
def main():
    p=argparse.ArgumentParser(description="Universal Financial Audio Intelligence Engine v4.4")
    ...
    result=run_pipeline(
        ...
        privacy_profile=a.privacy_profile,use_semantic_ai=a.semantic_ai,
